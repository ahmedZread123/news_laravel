...
<head>
    ...
    <title>24 News - @yield('title')</title>
            ...
            <nav class="navbar navbar-toggleable-md navbar-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " href="{{route('Home_admin')}}" >Admin <span class="sr-only">(current)</span></a>
                        </li>
                        @endauth
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 col-lg-2">
                ...
                <ul class="footer_menu">
                    ...
                    <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; {{$item->title }}</a></li>
                    @endforeach
...
<div class="container-fluid fh5co_footer_right_reserved">
    <div class="container">
        <div class="row  ">
            <div class="col-12 col-md-6 py-4 Reserved"> © Copyright {{date('Y')}}, All rights reserved. Design by <a href="https://freehtml5.co" title="Free HTML5 Bootstrap templates">FreeHTML5.co</a>. </div>
